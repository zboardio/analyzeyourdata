...
- **Interactive AG Grid** — sort, filter, group, and pivot your data with enterprise-grade tools
- **Up to 3 independent charts** — choose from {{VALUE_CHART_TYPE_SUPPORTED}} chart types
